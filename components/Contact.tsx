        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-16 flex flex-col md:flex-row items-center justify-center gap-12">
             <div className="flex items-center gap-3">
               ...
               <span className="text-white font-tech text-xs tracking-widest uppercase">info@tefdevs.com</span>
             </div>
             <div className="flex items-center gap-3">
               <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
               <span className="text-white font-tech text-xs tracking-widest uppercase">Currently Accepting 5 New Sprints</span>
             </div>
          </div>
        </div>
      </div>
